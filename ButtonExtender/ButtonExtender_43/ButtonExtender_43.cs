...
namespace Gadgeteer.Modules.SchreiberDominik
{
    ...
    public class ButtonExtender : GTM.Module
    {
        ...
        // GTM.SchreiberDominik.ButtonExtender. This file will provide IntelliSense and documentation for the
        // interface and make it easier for developers to use the ButtonExtender module.        
        ...
        public ButtonExtender(int socketNumber, int socketNumberTwo)
        {
        ...
        /// <summary>
        /// Gets a value that indicates whether the button of the ButtonExtender is pressed.
        /// </summary>
        ...
        public delegate void ButtonEventHandler(ButtonExtender sender, ButtonState state);

        /// <summary>
        /// Raised when the button of the <see cref="ButtonExtender"/> is pressed.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Raised when the button of the <see cref="ButtonExtender"/> is released.
        /// </summary>
        /// <remarks>
        ...
        protected virtual void OnButtonEvent(ButtonExtender sender, ButtonState buttonState)
        {
